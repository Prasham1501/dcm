  ...
  return (
    <div className="space-y-6 p-6">
      <section className="rounded border-2 border-app-accent bg-app-surface p-6">
        <h1 className="text-2xl font-bold tracking-wide text-app-accent">ACCURATE BRIDGE</h1>
      ...
      <section className="rounded border border-app-border bg-app-surface p-4 text-xs">
        ...
        <ol className="list-decimal space-y-1 pl-5 text-app-text">
          ...
          <li>The bridge groups files by Study UID, waits for the debounce timer, then renders and prints automatically.</li>
          <li>Job history lives in <code>%APPDATA%\AccurateBridge\printed</code>; failures in <code>...\failed</code>.</li>
        </ol>
      </section>
      ...
      <section className="rounded border border-app-border bg-app-surface p-4 text-xs">
        ...
        <dl className="grid grid-cols-[150px_1fr] gap-y-1 text-app-text">
          ...
          <dt className="text-app-text-muted">Storage root</dt>
          <dd className="font-mono">%APPDATA%\AccurateBridge</dd>
          <dt className="text-app-text-muted">Logs</dt>
          <dd className="font-mono">%APPDATA%\AccurateBridge\logs\bridge-YYYY-MM-DD.log</dd>
        </dl>
      </section>

      <section className="rounded border border-app-border bg-app-surface p-4 text-xs">
        <h2 className="mb-2 text-sm font-bold text-app-accent">Testing tools</h2>
        <p className="text-app-text">
          Use DCMTK <code>echoscu</code> / <code>storescu</code> for end-to-end testing. Example:
        </p>
        <pre className="mt-2 overflow-auto rounded bg-black p-2 font-mono text-2xs text-green-400">
