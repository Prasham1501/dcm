...
const api = {
  ...
  adminDealers:      ()     => liveFetch('/admin/dealers'),
  adminSaveDealer:   (data) => liveFetch('/admin/dealers', { method: 'POST', body: data }),
  adminDeleteDealer: (id)   => liveFetch(`/admin/dealers/${id}`, { method: 'DELETE' }),
