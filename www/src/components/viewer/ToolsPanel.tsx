      ...
      {showCreate ? (
        <div className="border-t border-app-border pt-2 space-y-1.5">
          ...
          <input
            ...
            className="w-full px-2 py-1 text-[10px] bg-app-bg text-app-text border border-app-border rounded focus:border-app-accent focus:outline-none"
          />
          <datalist id="viewer-stamp-categories">
          ...
          <div className="flex gap-1">
            <button
              ...
              className="flex-1 px-2 py-1.5 text-[10px] bg-green-600 text-white rounded font-bold hover:bg-green-500 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Save Stamp
            </button>
